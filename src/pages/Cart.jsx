...
const Cart = () => {
  ...
  return (
    <div className="mb-10">
      {cart.length > 0 ? (
        <div className="flex justify-center  flex-col lg:flex-row lg:w-8/12 max-[1300px] items-start mx-auto gap-x-5">
          ...
          <div className="w-[40%] mt-5 flex flex-col">
            <div className="flex flex-col justify-between p-5 gap-5 my-14">
